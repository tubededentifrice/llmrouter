...
def test_live_proof_covers_sdk_harness_and_native_operation_families() -> None:
    ...
    for evidence in (
        ...
        "assignment_inspector_text",
        "The {node_id} inspector did not restore focus",
        '"provider:fake-provider",\n            "Enter"',
        '"model:text-model",\n            "Space"',
        "route_inspector_text",
