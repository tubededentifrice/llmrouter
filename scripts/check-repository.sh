...
required_files=(
  ...
  "tsconfig.json"
  "uv.lock"
  "packages/backend-role/src/llmrouter_backend/database/migrations/0001_foundation.up.sql"
  "packages/backend-role/src/llmrouter_backend/database/migrations/0001_foundation.down.sql"
...
uv run python "${repository_root}/scripts/check-backend-reset.py"
