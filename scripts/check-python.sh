...
uv run ruff format --check packages scripts/check-dependency-policy.py scripts/generate-contract-digests.py
uv run ruff check packages scripts/check-dependency-policy.py scripts/generate-contract-digests.py
